...
const services = [
  ...
  { name: "AC Installation", description: "New split or window AC installation with proper mounting and gas charging.", category: "HVAC", basePrice: 1999, duration: 120, slug: "ac-installation", image: "https://images.unsplash.com/photo-1585338107529-13afc5f02586?w=600&h=400&fit=crop" },
  ...
  { name: "Pest Control - General", description: "Effective pest control treatment for cockroaches, ants, and mosquitoes.", category: "Pest Control", basePrice: 899, duration: 90, slug: "pest-control-general", image: "https://images.unsplash.com/photo-1504148455328-c376907d081c?w=600&h=400&fit=crop" },
  { name: "Termite Treatment", description: "Complete termite protection treatment for your home and furniture.", category: "Pest Control", basePrice: 2499, duration: 180, slug: "termite-treatment", image: "https://images.unsplash.com/photo-1588421357574-87938a86fa28?w=600&h=400&fit=crop" },
